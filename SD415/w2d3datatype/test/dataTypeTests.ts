...
import { readNumber,readNumber2,getRandomNumber,ucFirst,checkSpam ,truncate,extractCurrencyValue,getMaxSubSum,camelize} from "../src/app.js";
...
describe("checkSpam", function() {
  ...
  it('finds spam in "free xxxxx"', function() {
    assert.strictEqual(checkSpam("not thrsjdkfcjsdhzjfxck free xxxxx ",['buy ViAgRA now','free xxxxx','innocent rabbit']), true);
  });

  it('no spam in "innocent rabbit"', function() {
    assert.strictEqual(checkSpam("not thrsjdkfcjsdhzjfxck free ",['buy ViAgRA now','free xxxxx','innocent rabbit']), false);
  });
});
