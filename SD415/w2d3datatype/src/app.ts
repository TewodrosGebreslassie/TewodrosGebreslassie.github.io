...
export function readNumber(arr:string[]):any{
...
export function readNumber2(arr:string[]):any{
  ...
  function occasionalInfiniteLoop(): void {
    let count = 0;
...
return newstr;
   ...
   * @param {*} str 
   */
  export  function checkSpam(str:any,checker:string[]):boolean {
